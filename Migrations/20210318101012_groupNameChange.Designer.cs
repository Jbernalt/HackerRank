...
namespace HackerRank.Migrations
{
    ...
    [Migration("20210318101012_groupNameChange")]
    partial class groupNameChange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GitLabGroupUser", b =>
                {
            ...
            modelBuilder.Entity("HackerRank.Models.GitLabGroups.GitLabGroup", b =>
                {
            ...
            modelBuilder.Entity("HackerRank.Models.GitLabGroups.GroupTransaction", b =>
                {
                    b.Property<int>("GroupId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GitLabGroupUser", b =>
                {
                    b.HasOne("HackerRank.Models.GitLabGroups.GitLabGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HackerRank.Models.GitLabGroups.GroupTransaction", b =>
                {
                    b.HasOne("HackerRank.Models.GitLabGroups.GitLabGroup", "Group")
                        .WithMany()
